...
@objc public class UInnIAPReceiptInApp:NSObject, Codable {
    /// 购买的项目的数量。
    ...
    @objc public let expires_date:String?
    ...
    @objc public let expiration_intent:String?
...
extension UInnIAPReceiptInApp {
    ...
    public var expiresDate:Date?  {
        if let expiresDateString = self.expires_date {
