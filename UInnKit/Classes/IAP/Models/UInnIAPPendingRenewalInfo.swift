...
/// 注意：App Store返回的JSON中有很多看起来很有用的字段，但如果这些字段没有在“官方文档”中列出，在BBIPendingRenewalInfo类进行修改，
...
internal class UInnIAPPendingRenewalInfo:NSObject, Codable {
